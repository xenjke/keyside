    ...
    groups: [
      {
        ...
        keys: [
          ...
          { keys: '⌃D / ⌃U', desc: 'Half page down / up' },
          { keys: '⌃F / ⌃B', desc: 'Page down / up' },
          { keys: 'gg / ge', desc: 'First / last line' },
          { keys: 'W / B', desc: 'Next / previous WORD start' },
      ...
      },
      {
        ...
        keys: [
          ...
          { keys: '⌥u / ⌥U', desc: 'Move back / forward in undo history' },
      ...
      },
      {
        ...
        keys: [
          ...
          { keys: '⌃C', desc: 'Comment / uncomment selections' },
          { keys: 'C / ⌥C', desc: 'Copy selection to next / previous line' },
          { keys: 'J', desc: 'Join lines inside selection' },
          { keys: '⌥o / ⌥i', desc: 'Expand / shrink to parent · child node' },
          { keys: '⌥p / ⌥n', desc: 'Select previous / next sibling node' },
          { keys: '⌥a', desc: 'Select all sibling nodes' },
          { keys: '⌥I', desc: 'Select all children nodes' },
          { keys: '⌥e / ⌥b', desc: 'Move to parent node end / start' },
        ],
      },
      {
        name: 'Search',
      ...
      },
      {
        name: 'Goto mode',
        keys: [
          { keys: 'g|', desc: 'Go to column' },
          { keys: 'gh / gl', desc: 'Line start / end' },
          { keys: 'gs', desc: 'First non-blank char in line' },
          { keys: 'gd / gD', desc: 'Go to definition / declaration' },
          { keys: 'gy', desc: 'Go to type definition' },
          { keys: 'gr / gi', desc: 'Find references / implementation' },
          { keys: 'gt / gc / gb', desc: 'Screen top · middle · bottom' },
          { keys: 'ga / gm', desc: 'Last accessed / modified file' },
          { keys: 'gn / gp', desc: 'Next / previous buffer' },
          { keys: 'gk / gj', desc: 'Move up / down' },
          { keys: 'g.', desc: 'Last modification' },
          { keys: 'gf', desc: 'Go to file or URL in selection' },
          { keys: 'gw', desc: 'Jump to a two-character label' },
        ],
      },
      {
        name: 'Window mode',
        keys: [
          ...
          { keys: '⌃W h j k l', desc: 'Move to split' },
          { keys: '⌃W H J K L', desc: 'Swap window in direction' },
          { keys: '⌃W f / F', desc: 'Go to file in selection (split h / v)' },
      ...
      },
      {
        ...
        keys: [
          ...
          { keys: '␣ c', desc: 'Comment / uncomment selections' },
          { keys: '␣ C', desc: 'Block comment selections' },
          { keys: '␣ ⌥c', desc: 'Line comment selections' },
          { keys: "␣ '", desc: 'Last fuzzy picker' },
          { keys: '␣ /', desc: 'Global search' },
          { keys: '␣ ?', desc: 'Command palette' },
          { keys: '␣ y / p / P', desc: 'Yank · paste after / before (clipboard)' },
          { keys: ']d / [d', desc: 'Next / previous diagnostic' },
        ],
      },
    ],
